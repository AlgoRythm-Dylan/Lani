...
`,Lani.TableTemplates.NoDataFound="<p>No Data Found</p>",Lani.TableElement=class extends Lani.DataElement{#title;constructor(){super(),this.renderHeaders=!0,this.renderer=new Lani.TableRenderer(this),this.dataSource=null,this.autoParseColumns=!0,this.columns=[],this.ignoreColumns=[],this.columnNamePrettifier=new Lani.DataNamePrettifier,this.loadingTemplate=Lani.TableTemplates.Loading,this.noDataFoundTemplate=Lani.TableTemplates.NoDataFound,this.setup()}async setup(){await this.useTemplate(Lani.templatesPath(),"#lani-table",!1),this.linkStyle(Lani.contentRoot+"/tables.css"),this.doDiscovery(),this.renderTable(),this.ready()}get title(){return this.#title}set title(e){this.#title=e,Lani.useGenericTemplate(this.#title,this.shadow.getElementById("title"),!1)}async renderTable(){var e;null!==this.renderer&&null!==this.dataSource&&(e=await this.dataSource.get(),this.autoParseColumns&&0===this.columns.length&&this.parseColumns(e),this.renderer.render(e))}setBody(e){var t=this.shadow.getElementById("body");Lani.useGenericTemplate(e,t,!1)}showLoading(){this.setBody(this.loadingTemplate)}showNoDataFound(){}doDiscovery(){this.discoverTitle(),this.discoverColumns(),this.discoverDataSource()}discoverColumns(){let e=Array.from(this.querySelectorAll("lani-table-column"));0!==e.length&&(this.columns=e.map(e=>e.column))}discoverDataSource(){var e=this.querySelector("lani-data-source");e&&(this.dataSource=e.dataSource)}discoverTitle(){let e=null;var t=this.querySelector("template#title");return t&&(e=t),this.title=e}parseColumns(e){this.columns=[];for(var i of e.rows)for(let t of Object.keys(i.data))this.ignoreColumns.includes(t)||this.columns.some(e=>e.sourceName===t)||this.columns.push(new Lani.TableColumn(this.columnNamePrettifier.prettify(t),t));return this.columns}},Lani.regEl("lani-table",Lani.TableElement),Lani.installedModules.push("lani-testing"),Lani.TestError=class extends Error{constructor(e){super(e)}},Lani.assertEqual=(e,t)=>{if(e!=t)throw new Lani.TestError(e+" should be equal to "+t)},Lani.assertStrictlyEqual=(e,t)=>{if(e!==t)throw new Lani.TestError(e+" should be strictly equal to "+t)},Lani.assertInequal=(e,t)=>{if(e==t)throw new Lani.TestError(e+" should not be equal to "+t)},Lani.assertStrictlyInequal=(e,t)=>{if(e===t)throw new Lani.TestError(e+" should not be strictly equal to "+t)},Lani.assertGreaterThan=(e,t)=>{if(!(t<e))throw new Lani.TestError(e+" should be greater than "+t)},Lani.assertLessThan=(e,t)=>{if(!(e<t))throw new Lani.TestError(e+" should be less than "+t)},Lani.assertGreaterThanEq=(e,t)=>{if(!(t<=e))throw new Lani.TestError(e+" should be greater than or equal to "+t)},Lani.assertLessThanEq=(e,t)=>{if(!(e<=t))throw new Lani.TestError(e+" should be less than or equal to "+t)},Lani.PerformanceTest=class{constructor(){this.iterations=1e6,this.start=null,this.end=null}test(){}get time(){return this.end-this.start}};