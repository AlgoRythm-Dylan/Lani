...
`,Lani.TableElement=class extends Lani.DataElement{#title;constructor(){super(),this.renderHeaders=!0,this.renderer=new Lani.TableRenderer(this),this.dataSource=null,this.autoParseColumns=!0,this.columns=[],this.loadingTemplate=null,this.noDataFoundTemplate=null,this.setup()}async setup(){await this.useTemplate(Lani.templatesPath(),"#lani-table",!1),this.linkStyle(Lani.contentRoot+"/tables.css");var t=this.getAttribute("table-title"),t=(t&&(this.title=t),this.getAttribute("download-data"));t&&this.downloadData(t),this.ready()}get title(){return this.#title}set title(t){this.#title=t,this.shadow.getElementById("title").innerHTML=t}setBody(t){let e=this.shadow.getElementById("body");e.innerHTML="","string"==typeof e?e.innerHTML=t:e.appendChild(t)}showLoading(){this.setBody(this.loadingTemplate)}showNoDataFound(){}async downloadData(t){t=await(await fetch(t)).json();this.dataSource=new Lani.InMemoryDataSource(t)}},Lani.regEl("lani-table",Lani.TableElement),Lani.installedModules.push("lani-testing"),Lani.UnitTestError=class extends Error{constructor(t){super(t)}},Lani.assertEqual=(t,e)=>{if(t!==e)throw new Lani.UnitTestError(t+" is not equal to "+e)},Lani.UnitTest=class{constructor(){}evaluate(){}},Lani.PerformanceTest=class{constructor(){this.iterations=1e6,this.start=null,this.end=null}test(){}get time(){return this.end-this.start}},Lani.UnitTests=[],Lani.PerformanceTests=[],`<!-- Reference: https://developer.mozilla.org/en-US/docs/Web/SVG/Element -->
