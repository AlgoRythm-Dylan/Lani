...
`,Lani.TableTemplates.NoDataFound="<p>No Data Found</p>",Lani.TableElement=class extends Lani.DataElement{#title;constructor(){super(),this.renderHeaders=!0,this.renderer=new Lani.TableRenderer(this),this.dataSource=null,this.autoParseColumns=!0,this.columns=[],this.ignoreColumns=[],this.columnNamePrettifier=new Lani.DataNamePrettifier,this.loadingTemplate=Lani.TableTemplates.Loading,this.noDataFoundTemplate=Lani.TableTemplates.NoDataFound,this.setup()}async setup(){await this.useTemplate(Lani.templatesPath(),"#lani-table",!1),this.linkStyle(Lani.contentRoot+"/tables.css");var e=this.getAttribute("table-title"),e=(e&&(this.title=e),this.getAttribute("download-data"));e&&this.downloadData(e),this.ready()}get title(){return this.#title}set title(e){this.#title=e,this.shadow.getElementById("title").innerHTML=e}setBody(e){let t=this.shadow.getElementById("body");t.innerHTML="","string"==typeof e?t.innerHTML=e:t.appendChild(e)}showLoading(){this.setBody(this.loadingTemplate)}showNoDataFound(){}async downloadData(e){e=await(await fetch(e)).json();this.dataSource=new Lani.InMemoryDataSource(e)}parseColumns(e){this.columns=[];for(var i of e.rows)for(let t of Object.keys(i.data))this.ignoreColumns.includes(t)||this.columns.some(e=>e.sourceName===t)||this.columns.push(new Lani.TableColumn(this.columnNamePrettifier.prettify(t),t));return this.columns}},Lani.regEl("lani-table",Lani.TableElement),Lani.installedModules.push("lani-testing"),Lani.UnitTestError=class extends Error{constructor(e){super(e)}},Lani.assertEqual=(e,t)=>{if(e!==t)throw new Lani.UnitTestError(e+" is not equal to "+t)},Lani.UnitTest=class{constructor(){}evaluate(){}},Lani.PerformanceTest=class{constructor(){this.iterations=1e6,this.start=null,this.end=null}test(){}get time(){return this.end-this.start}},Lani.UnitTests=[],Lani.PerformanceTests=[];